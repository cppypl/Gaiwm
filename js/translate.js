...
window["_mstConfig"] = {
  appId:
    "Y9nhlGvgkSSCvp4HfFTwckQnFnVUjsFUx3ojN8NIrmSfAVx8Hltn4pgvtUxVA4Is6kzfPtRaSPbXtzV_waxgebFNsOwyNLqZ0R3jQEVyB11LJs2htf3tG-bg5i2lxfX-X",
  rootURL: "http\x3a\x2f\x2fwww.microsofttranslator.com\x2f",
  baseURL:
    "http\x3a\x2f\x2fwww.microsofttranslator.com\x2fajax\x2fv3\x2fWidgetV3.ashx\x3fsiteData\x3dueOIGRSKkd965FeEGM5JtQ\x2a\x2a",
  serviceURL: "https\x3a\x2f\x2fapi.microsofttranslator.com\x2fv2\x2fajax.svc",
  imagePath:
    "http\x3a\x2f\x2fwww.microsofttranslator.com\x2fstatic\x2f25824067\x2fimg\x2f",
  debug: false,
  locale: "zh-chs",
  country: "",
  category: "",
...
window._mstConfig["SignIn"] =
  '<a href="https://login.live.com/login.srf?wa=wsignin1.0&amp;rpsnv=13&amp;ct=1552922624&amp;rver=6.7.6636.0&amp;wp=LBI&amp;wreply=http:%2F%2Fwww.microsofttranslator.com%2Fajax%2Fv2%2Fauth.aspx%3Fpru%3Dhttps%253a%252f%252fblog.csdn.net%252fweixin_40687883%252farticle%252fdetails%252f81451385&amp;lc=2052&amp;id=268160">登录</a>';
...
Microsoft.Translator = new function() {
  ...
  k.GetAppIdToken = function(g, c, a, b, d, e, f) {
    return new z(
      "GetAppIdToken",
      { appId: g, minRatingRead: c, maxRatingWrite: a, expireSeconds: b },
      d,
      e,
      f
    );
  ...
  k.GetLanguageNames = function(f, e, a, b, c, d) {
    return new z(
      "GetLanguageNames",
      { appId: f, locale: e, languageCodes: a },
      b,
      c,
      d
    );
  ...
  k.GetTranslations = function(f, h, g, i, a, d, b, c, e) {
    return new z(
      "GetTranslations",
      { appId: f, text: h, from: g, to: i, maxTranslations: a, options: d },
      b,
      c,
      e
    );
  ...
  k.Translate = function(f, h, g, i, a, c, b, d, e) {
    return new z(
      "Translate",
      { appId: f, text: h, from: g, to: i, contentType: a, category: c },
      b,
      d,
      e
    );
  ...
  k.AddTranslationArray = function(f, a, g, h, d, b, c, e) {
    return new z(
      "AddTranslationArray",
      { appId: f, translations: a, from: g, to: h, options: d },
      b,
      c,
      e
    );
  ...
  k.GetTranslationsArray = function(f, g, h, i, a, d, b, c, e) {
    return new z(
      ...
      { appId: f, texts: g, from: h, to: i, maxTranslations: a, options: d },
      b,
      c,
      e
    );
  ...
  k.Speak = function(g, h, b, f, d, a, c, e) {
    return new z(
      "Speak",
      { appId: g, text: h, language: b, format: f, options: d },
      a,
      c,
      e
    );
  ...
  k.TranslateArray = function(e, f, g, h, c, a, b, d) {
    return new z(
      "TranslateArray",
      { appId: e, texts: f, from: g, to: h, options: c },
      a,
      b,
      d
    );
  ...
  var Rb = (c.serviceClient.LoadScript = new function() {
      ...
      return function(f, i, a) {
        ...
        if ((navigator.userAgent.indexOf("MSIE") > e && g > 2048) || g > 8192)
          return j;
    ...
    nc = new function() {
      ...
      return function(b) {
        ...
        else if (typeof b.constructor === L && a[b.constructor])
    ...
    gc = new function() {
      var b = j;
      if (
        navigator.userAgent.toLowerCase().indexOf("msie 6.") > e ||
        (navigator.userAgent.toLowerCase().indexOf("webkit") > e &&
          (document.charset || document.characterSet || a)
            .toLowerCase()
            .indexOf("utf") == e)
      )
        c.escapeNonAscii = p;
      ...
      function r(a) {
        ...
        if ((g.length < h.length && b > 34) || (c.escapeNonAscii && b > 122))
          return g;
        else return h;
      }
      function h(a) {
    ...
    z = new function() {
      ...
      if (f.indexOf("utf") == e && f.indexOf("unicode") == e)
        try {
          c.escapeNonAscii = p;
            ...
            setTimeout(function() {
              ...
              if (b)
                if (window == window.top) {
                  ...
                  window.parent.postMessage(X + a.toString(), d);
            }, 0);
          });
        function w() {
          try {
  ...
  var h = new function() {
    ...
    for (var s = 0; s < u.length; ++s)
      for (var w = 0; w < u[s].l; ++w)
        l.push(String.fromCharCode(u[s].a.charCodeAt(0) + w));
    ...
    var d = (b.getStyleValue = function(c, b) {
      ...
      M = (b.fixIEQuirks = function(a) {
        ...
        if (f && f.indexOf(i) > e)
          a.style.width =
            parseInt(f) +
            parseInt(g + d(a, "borderLeftWidth")) +
            parseInt(g + d(a, "borderRightWidth")) +
            parseInt(g + d(a, "paddingLeft")) +
            parseInt(g + d(a, "paddingRight")) +
            i;
        var c = d(a, "height");
        if (c && c.indexOf(i) > e)
          a.style.height =
            parseInt(c) +
            parseInt(g + d(a, "borderTopWidth")) +
            parseInt(g + d(a, "borderBottomWidth")) +
            parseInt(g + d(a, "paddingTop")) +
            parseInt(g + d(a, "paddingBottom")) +
            i;
    ...
    b.absXPos = function(a) {
      if (a.getBoundingClientRect)
        return (
          ...
          (Math.max(
            a.ownerDocument.documentElement.scrollLeft,
            a.ownerDocument.body.scrollLeft
          ) -
            Math.max(
    ...
    function B(a) {
      return (
        a.offsetLeft +
        (a.offsetParent && a.offsetParent.nodeType == 1 ? B(a.offsetParent) : 0)
      );
    }
    function C(a) {
      return (
        (a.parentNode && a.parentNode.nodeType == 1 ? C(a.parentNode) : 0) +
        (a.nodeName.toLowerCase() != "html" &&
        a.nodeName.toLowerCase() != "body" &&
        a.scrollLeft
          ? -a.scrollLeft
          : 0)
      );
    ...
    b.absYPos = function(a) {
      if (a.getBoundingClientRect)
        return (
          ...
          (Math.max(
            a.ownerDocument.documentElement.scrollTop,
            a.ownerDocument.body.scrollTop
          ) -
            Math.max(
              a.ownerDocument.documentElement.clientTop,
              a.ownerDocument.documentElement.offsetTop
            ))
        );
      else return D(a) + F(a);
    };
    function D(a) {
      return (
        a.offsetTop +
        (a.offsetParent && a.offsetParent.nodeType == 1 ? D(a.offsetParent) : 0)
      );
    }
    function F(a) {
      return (
        (a.parentNode && a.parentNode.nodeType == 1 ? F(a.parentNode) : 0) +
        (a.nodeName.toLowerCase() != "html" &&
        a.nodeName.toLowerCase() != "body" &&
        a.scrollTop
          ? -a.scrollTop
    ...
    b.getVisibleWidth = function(b) {
      ...
      if (window.innerWidth && window.innerWidth > a) a = window.innerWidth;
        ...
        b.documentElement.clientWidth > a
      )
        a = b.documentElement.clientWidth;
      else if (b.body.clientWidth && b.body.clientWidth > a)
        a = b.body.clientWidth;
      return a;
    };
    ...
    b.getStringByteCount = function(a) {
      return c.escapeNonAscii
        ? encodeURIComponent(a).length
        : encodeURIComponent(a).replace(/%\w\w/g, " ").length;
    };
    var J = (b.getBlockParent = function(a) {
        ...
        return b &&
          b.toLowerCase() == "inline" &&
          c.toLowerCase() == "static" &&
          a.parentNode &&
          a.parentNode.nodeType == 1
          ? J(a.parentNode)
          : a;
      }),
    ...
    b.setGradient = function(a, b, c, d) {
      ...
      if (a._mstGradCol1 != b.toString() || a._mstGradCol2 != c.toString()) {
        if (a._mstGradElem && a._mstGradElem.parentNode == a)
          a.removeChild(a._mstGradElem);
        if (b.toString() == c.toString())
          ...
          a.style.backgroundImage =
            "url('data:image/x-ms-bmp;base64," + K(H(b, c, d)) + "')";
        }
    ...
    function I(a, b, c, f) {
      ...
      a._mstGradElem.firstChild.style.height = a._mstGradElem.lastChild.style.height =
        f / 2 + i;
      a._mstGradElem.firstChild.style.fontSize = a._mstGradElem.lastChild.style.fontSize = k;
      a._mstGradElem.firstChild.style.filter =
        d + c + e + c.interpolate(b, 0.5) + ")";
      a._mstGradElem.lastChild.style.filter =
        d + b + e + b.interpolate(c, 0.5) + ")";
    }
    function H(f, g, c) {
      var e = 1 * c,
        a = [];
      ...
      for (var b = 0; b < c; ++b) {
        var d =
          b < c / 2 ? f.interpolate(g, 0.5 - b / c) : f.interpolate(g, b / c);
        a.push(d.b);
        a.push(d.g);
        a.push(d.r);
        a.push(x);
  ...
  function C(e, d, c) {
    ...
    a.interpolate = function(b, c) {
      ...
      return new C(
        Math.round(a.r + c * (b.r - a.r)),
        Math.round(a.g + c * (b.g - a.g)),
        Math.round(a.b + c * (b.b - a.b))
      );
    };
    return a;
  }
  C.parse = function(a) {
    ...
    if (b)
      return new C(parseInt(b[1], 10), parseInt(b[2], 10), parseInt(b[3], 10));
    a = a.split(" ")[0];
    if (a.substr(0, 1) == "#") {
      if (a.length == 4)
        return new C(
          f * parseInt(a.substr(1, 1), f),
          f * parseInt(a.substr(2, 1), f),
          f * parseInt(a.substr(3, 1), f)
        );
      else if (a.length == 7)
        return new C(
          parseInt(a.substr(1, 2), f),
          parseInt(a.substr(3, 2), f),
          parseInt(a.substr(5, 2), f)
        );
    } else if (C.nameTable[a.toLowerCase()])
      return C.parse(C.nameTable[a.toLowerCase()]);
  ...
  function mc(Fb, nb, qb, ob, db, Gc, Cc, P, J, Lc) {
    ...
    if (
      navigator.userAgent &&
      (navigator.userAgent.indexOf("Chrome") > e ||
        navigator.userAgent.indexOf("Mobile") > e)
    ) {
      ec /= 3;
      E /= 2;
      dc /= 3;
    ...
    h.addEvent(
      l.ownerDocument.defaultView || l.ownerDocument.parentWindow,
      Yb,
      Wb
    );
    var Fc = (x.cancel = function() {
      if (
        ...
        Microsoft.TranslatorOverride.hideTooltip
      )
        Microsoft.TranslatorOverride.hideTooltip();
      if (!l) return;
      Db = i;
    ...
    var m = { Inherit: 0, On: 1, Off: 2, Skip: 3 },
      cc = {
        google: {
          value: { notranslate: m.Off },
          content: { notranslate: m.Off }
        },
        microsoft: {
          value: { notranslate: m.Off },
          content: { notranslate: m.Off }
    ...
    function xb(b) {
      var a;
      if (fc[b] == w) a = { direction: w, textAlign: U };
      else a = { direction: d, textAlign: F };
      return a;
    }
    if (!P && !J) bb = xb(ob);
    function zc() {
      ...
      for (var a = b.length - 2; a >= 0; --a)
        if (b[a].id) {
          ...
          c.unshift(
            (b[a].nodeName && b[a].nodeName.toLowerCase
    ...
    function B() {
      ...
      while (b.length > 0 && (Bb < fb || f.length)) {
        if (b.length && tc(b.top()) && ab(b.top())) {
          ...
          e = i;
          h.addEvent(
            b.top().ownerDocument.defaultView ||
              b.top().ownerDocument.parentWindow,
            Yb,
            Wb
          );
          if (hb) {
            var d =
              typeof b.top().length == sb
                ? b.top().length
                : b.top().getAttribute(a) ||
                  (b.top().innerHTML && b.top().innerHTML.length
                    ? b.top().innerHTML.length
                    : 0);
            try {
              if (!b.top().length && !b.top().getAttribute(a))
                b.top().setAttribute(a, d);
            } catch (o) {}
            n[n.length - 1].o = d;
            ub += d;
          }
          ...
          b.length &&
          b.top().firstChild &&
          b.top().firstChild.parentNode == b.top() &&
          !jb(b.top()) &&
          ab(b.top())
        ) {
          ...
          while (
            b.length &&
            (!b.top().nextSibling && !b.top().nextElementSibling)
          ) {
            b.pop();
            W.pop();
            n.pop();
          ...
          if (b.length > 1) {
            if (hb && b.top().nodeName.toLowerCase() != Xb)
              n[n.length - 2].p += parseInt(n[n.length - 1].o);
        ...
        if (b.length) {
          if (b.top().clientHeight < b.top().scrollHeight)
            h.addEvent(b.top(), Yb, Wb);
          if (jb(b.top())) {
            if (!j) j = zc();
            ++W[W.length - 1];
            f.push(b.top());
          }
          if (b.top().nodeName.toLowerCase() != Xb && !ab(b.top()))
            Ob += parseInt(n.top().o);
          Sb(b.top());
        }
      }
      if (Bb > 0 || vb.length > 0) Ac();
        ...
        if (
          Microsoft.TranslatorOverride &&
          Microsoft.TranslatorOverride.showHighlight
        )
          Microsoft.TranslatorOverride.showHighlight(k, L, O);
    ...
    function Sb(a) {
      ...
      try {
        ...
        a.adjustAlign =
          a.getAttribute(f) && !(a.getAttribute(f).toLowerCase() == M);
          ...
          for (var b in bb)
            try {
              ...
              if (d != bb[b]) {
                if (
                  b == "textAlign" &&
                  ((d && d.toLowerCase().indexOf(G) != e) ||
                    (a.tagName && a.tagName.toLowerCase() == G))
                )
                  continue;
                if (Hb) {
    ...
    function Kb(e) {
      ...
      if (!S)
        ...
        else if (l.documentElement.getElementsByTagName)
          S = l.documentElement.getElementsByTagName(y);
        else if (l.ownerDocument.documentElement.getElementsByTagName)
          S = l.ownerDocument.documentElement.getElementsByTagName(y);
      var a;
    ...
    function xc() {
      if (!H || !k.sourceFrame) {
        ...
        b.push(
          "dtc=" +
            encodeURIComponent(k.detectedLanguage ? k.detectedLanguage : v)
        );
        var d = ib.join(" | "),
        ...
        for (var a = 0; a < z.length && a < 64; ++a) {
          b.push(
            a.toString() +
              "=" +
              [z[a].r, z[a].c, z[a].s, z[a].e, z[a].l].join("_")
          );
          if (z[a].r === "E") n++;
          if (z[a].l > e) e = z[a].l;
          g += z[a].c;
        ...
        if (window.mscc === undefined || window.mscc.hasConsent()) {
          if (typeof telemetry !== V && telemetry)
            telemetry.trackMetric([
              { metric: "translation.calls", value: o },
              { metric: "translation.errors", value: n },
              { metric: "translation.characters", value: g },
              { metric: "translation.sentences", value: j },
              { metric: "tranlation.elements", value: m },
              { metric: "translation.latencies", value: i },
              { metric: "translation.time", value: l },
              { metric: "translation.to", value: O },
              { metric: "translation.from", value: L }
            ]);
    ...
    function jb(a) {
      if (a.nodeType == 3) return i;
        ...
        a.nodeType != 1 ||
        a._mstChunk ||
        h.getStyleValue(a, "display").toLowerCase() != "inline" ||
        h.getStyleValue(a, mb).toLowerCase() != "static" ||
        rb[a.nodeName.toLowerCase()]
      )
        return s;
      for (var b = 0; b < a.childNodes.length; ++b)
    ...
    function Vb(a) {
      ...
      if (a.length > 0)
        if (a.length == 1 && a[0].nodeType == 1) b = a.pop();
          ...
          a[0].parentNode &&
          a.length == a[0].parentNode.childNodes.length
        ) {
          b = a.pop().parentNode;
    ...
    function T(a, i, e) {
      ...
      var d = [],
        ...
        l = 0;
      for (var b = 0; b < a.childNodes.length; ++b)
        switch (a.childNodes[b].nodeType) {
          case 1:
            ...
            if (
              g == m.Skip &&
              a.childNodes[b].previousSibling &&
              a.childNodes[b].previousSibling.nodeType == 1
            )
              a.childNodes[b].previousSibling._mstSkipNext = f;
            else if (
              g == m.Skip &&
              a.childNodes[b].nextSibling &&
              a.childNodes[b].nextSibling.nodeType == 1
            )
              a.childNodes[b].nextSibling._mstSkipPrev = f;
            else {
              d.push("<");
              d.push(j);
              d.push(">");
          ...
          case 3:
            if (a.childNodes[b].nodeValue) {
              ...
              if (h != a.childNodes[b].nodeValue)
                a.replaceChild(
                  a.ownerDocument.createTextNode(h),
                  a.childNodes[b]
                );
              d.push(Nc(h));
            }
    ...
    function Nc(a) {
      if (c.service == Gb && Default.Globals.PhraseAlignment)
        return a.replace(/[\s\xA0]/g, gb);
      else
        return a
          .replace(/&/g, "&amp;")
          .replace(/</g, "&lt;")
    ...
    function Ac() {
      ...
      if (vb.length > 0 && !eb) {
        ...
        Cb = A[0].length;
        pb = 1;
        lb = c.serviceClient.TranslateArray(
          Fb,
          [A[0]],
          L,
          O,
          c.category ? { Category: c.category } : g,
          mc,
          wb,
          kb
        );
      ...
      do {
        ...
        Qb.length > 0 &&
        a < fb &&
        a + f + (b.length + 1) * h.getStringByteCount('"",') <= sc
      );
    ...
    function mc(a) {
      ...
      k.detectedLanguage =
        a && a[0] && a[0].From ? a[0].From.toLowerCase() : k.detectedLanguage;
      ...
      for (
        var d = 0;
        d < (A.length > 1 ? Math.max(f.length - 2, 1) : f.length);
        ++d
      ) {
    ...
    function Mc(b, a) {
      if (Db) return;
      window.Microsoft.Translator.translationCallsTime[a] =
        new Date().getTime() -
        window.Microsoft.Translator.translationCallsTime[a];
      ...
      Jb(b);
      k.detectedLanguage =
        b && b[0] && b[0].From ? b[0].From.toLowerCase() : k.detectedLanguage;
      ...
      var e = v;
      for (
        var f = t[a].Dom.shift(), g = t[a].Txt.shift(), d = b.shift();
        f && d;
        f = t[a].Dom.shift(), ((g = t[a].Txt.shift()), (d = b.shift()))
      ) {
        if (d.Alignment) {
          if (e.length != 0) e += "|";
          e += d.Alignment;
        ...
        try {
          jc(
            ...
            g,
            d.TranslatedText,
            d.OriginalTextSentenceLengths,
            d.TranslatedTextSentenceLengths
          );
        } catch (h) {
          if (c.debug);
        }
    ...
    function Jb(a) {
      ...
      if (a)
        for (var d = 0; d < a.length; ++d)
          c += a[d].OriginalTextSentenceLengths.length;
      else c = pb;
    ...
    var jc = (x.translateElement = function(a, n, m, j, l) {
      ...
      if (e.length > 2 && f.length > 2) {
        a._mstSrcHtml = a.innerHTML;
        for (var b = 0; b < e.length && b < f.length; ++b)
          uc(Vb(e[b]), Vb(f[b]), h * (b + 1));
      } else uc(a, d, h);
    ...
    function uc(a, b, d) {
      ...
      if (
        !f.match(/[a-zA-Z0-9\xC0-\uFFFF]/) &&
        !g.match(/[a-zA-Z0-9\xC0-\uFFFF]/)
      )
        return;
    ...
    function Pb(a) {
      ...
      if (a.nodeName.toLowerCase() == "frame" || a.nodeName.toLowerCase() == R)
        try {
  ...
  (function(d) {
    ...
    function jb(k, d, b) {
      ...
      d === void 0 && (d = "true"),
        (b === void 0 && (b = a),
        ((y = Util.GetElement(pb)),
        ((f = Util.GetElement(cb)),
        ((F = Util.GetElement(qb)),
        ((N = Util.GetElement(rb)),
        ((R = Util.GetElement(sb)),
        ((G = Util.GetElement(tb)), ((J = b == a), (h = b)))))))));
      ...
      l.insertBefore(e, l.firstChild),
        ((f.onmousedown = gb),
        (y.setAttribute(i, j),
        (y.setAttribute(vb, wb),
        (F.setAttribute(i, j),
        ((L = k),
        Microsoft.Translator.Widget.GetLanguagesForTranslate(k, T, U))))));
      var m = f.getElementsByTagName("input");
      for (var g = 0; g < m.length; g++) {
        var n = m[g];
        n.getAttribute("type").toLowerCase() == ab &&
          n.setAttribute("onclick", xb);
      }
      d.toLowerCase() == M && (W = !1),
        ((Z = !0),
        (window._bwmid ? (window._bwmid += yb) : (window._bwmid = zb),
        (Rb(Ab, (document.location.protocol == "https:" ? Bb : Cb) + Db),
        !V && W && (c.serviceClient.Community.forceLoad(), (V = !0)))));
    }
    function eb() {
      f.style.display = k;
    }
    function C(d) {
      ...
      if (!bb)
        if ((c = document.getElementById(Eb))) {
          ...
          window.Util.IsElementInViewport(c)
            ? b.left == 0 && b.top == 0
              ? setTimeout(function() {
        ...
        if (window.LanguageMenu) {
          ...
          try {
            ...
            (i = Util.GetElement(db)),
              h == a
                ? (i.parentNode.style.display = q)
                : ((i.parentNode.style.display = k),
                  J
                    ? (i.innerHTML = window._mstConfig.autoDetected.replace(
                        v,
                        o[h]
                      ))
                    : (i.innerHTML = o[h]));
    ...
    function t() {
      (y.style.display = q),
        ((N.style.display = q),
        ((F.style.display = q),
        ((R.style.display = q), ((A = !1), clearTimeout(p)))));
    }
    function w(a, b) {
    ...
    function mb(e) {
      ...
      if (d && window.LanguageMenu && window.LanguageMenu.getValue) {
        (h = d),
          ((i.parentNode.style.display = k),
          J
            ? (i.innerHTML = window._mstConfig.autoDetected.replace(v, o[h]))
            : (i.innerHTML = o[h]));
        var l = o[d],
          f = o[window.LanguageMenu.getValue()],
          g = location.href.substr(
            0,
            location.href.length - (location.hash || a).length
          ),
        ...
        (c = c.replace(
          v,
          encodeURIComponent(g + n + K + window.LanguageMenu.getValue())
        )),
          ((c = c.replace(P, encodeURIComponent(g))),
          (Util.GetElement(Hb).setAttribute(O, Ib + b + "&body=" + c),
          (Util.GetElement(Jb).setAttribute(
            "title",
            Util.GetElement(Kb)
              .getAttribute(m)
              .replace(v, f)
          ),
          window.Util.SetCookie("mstto", window.LanguageMenu.getValue(), !1))));
      }
    }
    function Ob(a) {
      console.log(a);
    ...
    function Vb() {
      var c = Lb;
      t(), eb();
      var b = location.href.substr(
        0,
        location.href.length - (location.hash || a).length
      );
      location.search.length == 0
        ? Util.GetElement(c).setAttribute(m, b + Mb + g)
        : location.search.indexOf("__mstto") != e
        ? b.match(/__mstto=(.+)([&]+)/i)
          ? Util.GetElement(c).setAttribute(
              m,
              b.replace(/__mstto=(.+)([&&]+)/i, K + g + r)
            )
          : b.match(/__mstto=(.+)/i) &&
            Util.GetElement(c).setAttribute(
              m,
              b.replace(/__mstto=(.+)/i, K + g)
            )
        : Util.GetElement(c).setAttribute(m, b + Nb + g),
        (N.style.display = k);
    }
    function Wb() {
      t(), (R.style.display = k);
    ...
    function U() {
      L != b &&
        ((L = b),
        Microsoft.Translator.Widget.GetLanguagesForTranslate(b, T, U));
    }
    function X() {
    ...
    function ac() {
      g.toLowerCase() != window[Yb].getValue().toLowerCase() &&
        (clearTimeout(p),
        (Microsoft.Translator.Widget.Translate(
          h,
          window.LanguageMenu.getValue()
        ),
        ((g = window.LanguageMenu.getValue()),
        window.LanguageMenu.elemHeader.focus())));
    }
    function gb(a) {
      return (
        (a = a || event),
        ((H = a.clientX),
        ((I = a.clientY),
        ((document.onmousemove = hb),
        ((document.onmouseup = ib),
        (document.body.focus(),
    ...
    function hb(a) {
      ...
      var b = Util.getPosition(f),
        ...
        d = a.clientY - I;
      return (
        w(parseInt(b.left) + c, parseInt(b.top) + d),
    ...
    function ib(a) {
      return (
        ...
        ((document.onselectstart = s),
        ((f.ondragstart = s), (Util.removeClass(f, fb), !1))))
      );
    }
    var o = {},
      L,
    ...
    (d.Initialize = jb),
      ((d.Show = C),
      ((d.TranslationComplete = lb),
      ((d.TranslationProgress = mb),
      ((d.TranslationError = Ob),
      ((d.OnClose = Pb),
      ((d.OnShareBackClick = Qb),
      ((d.OnEmbedBackClick = Sb),
      ((d.OnMouseOverFloater = Tb),
      ((d.OnMouseOutFloater = Ub),
      ((d.ShowSharePanel = Vb), (d.ShowEmbed = Wb)))))))))));
  })(t || (t = {})),
  ...
  var oc = (function() {
    ...
    function b() {
      ...
      (b.languageNames = []),
        ((b.langLocalized = d),
        ((b.appId = window._mstConfig.appId),
        ((b.unTranslateDelegate = d),
        ((b.Links = new pc(
          window._mstConfig.SignIn ? window._mstConfig.SignIn : a,
          window._mstConfig.SignOut ? window._mstConfig.SignOut : a,
          "http://go.microsoft.com/?linkid=9722454"
        )),
        ((b.UserName = window._mstConfig.UserName
          ? window._mstConfig.UserName
          : a),
        (b.languageCodes = []))))));
      for (var c in window.localizedLangs)
        b.languageCodes[b.languageCodes.length] = c;
    }
    return (
      (b.prototype.Translate = function(a, b, c, d, e, f, g) {
      ...
      ((b.prototype.TranslateElement = function(p, j, h, m, e, n, o, k, b) {
        ...
        h === void 0 && (h = document.documentElement),
          (b === void 0 && (b = !0),
          (a.validate(p, "from", !1, f), a.validate(j, "to", !0, f)));
        if (!a.isElement(h) && !a.isNode(h))
          throw new Error("Invalid DomElement");
        a.validate(m, "onProgress", !1, c),
          (a.validate(e, "onError", !1, c),
          (a.validate(n, i, !1, c),
          (a.validate(o, "onRestoreOriginal", !1, c),
          (a.validate(k, "timeOut", !1, g, !0),
          a.validate(b, "showFloater", !1, "boolean")))));
        var l = !1;
        (a.lastToLanguage = j),
          (a.domTranslator != d &&
            a.domTranslator.cancel &&
            a.domTranslator.cancel(),
          b && t.Show(j));
        var s = function() {
            q(u), (l = !0);
        ...
        (a.domTranslator = new mc(a.appId, h, p, j, s, e, k, !1, !1)),
          (a.domTranslator.addProgressEvent &&
            a.domTranslator.addProgressEvent(q),
          o && (a.unTranslateDelegate = o));
        if (e && k) {
      ...
      ((b.prototype.GetLanguagesForTranslate = function(b, e, h, j) {
        ...
        a.validate(b, "locale", !0, f),
          (a.validate(e, i, !0, c),
          (a.validate(h, "onError", !1, c),
          a.validate(j, "timeOut", !1, g, !0)));
        ...
        Microsoft.Translator.GetLanguageNames(
          a.appId,
          b,
          a.languageCodes,
          function(a) {
      ...
      ((b.prototype.GetLanguageNamesCallBack = function(b, d, g, e) {
        ...
        for (var a = 0; a < b.length; a++)
          c[a] = new jc(b[a], this.languageCodes[a]);
      ...
      ((b.prototype.GetLanguagesForTranslateLocalized = function() {
        ...
        if (!a.langLocalized) {
          a.langLocalized = [];
          for (var b in window.localizedLangs)
            a.langLocalized[a.langLocalized.length] = new jc(
              window.localizedLangs[b],
              b
            );
        }
      ...
      ((b.prototype.SetUpdatedAccessToken = function(c) {
        ...
        if (d && d.length > 0)
          for (var g = 0; g < d.length; g++) {
            ...
            if (
              h &&
              (h.toLowerCase().indexOf("roledashboard.aspx") != e ||
                h.toLowerCase().indexOf("bulkdashboard.aspx") != e)
            ) {
              var k = "https://" + i[2],
                k = k.replace("www.", "ssl.");
        ...
        var m = window._mstConfig.onErrorHandlerName
          ? Ob + window._mstConfig.onErrorHandlerName
          : a;
        f.src =
          (location && location.href && location.href.indexOf("https") == 0
            ? "https://ssl." + b
            : "http://www." + b) +
          "/ajax/v3/WidgetV3.ashx?action=refreshToken&trnsaccesstoken=" +
          c +
          m;
      ...
      ((b.prototype.UpdateAppID = function(a, b) {
        (this.appId = a),
          ...
          Microsoft.Translator.Widget.UpdateDashboardLink(
  ...
  var kc = new function() {
      ...
      return function(s, L, t, P, z, v) {
        ...
        var x = e,
          ...
          Q = (u.hover = function(d) {
            ...
            if (d && v && v[s._mstHash] && v[s._mstHash]._mstTooltip)
              v[s._mstHash]._mstTooltip.hover();
          }),
          bb = (u.unhover = function(a) {
            ...
            if (a && v && v[s._mstHash] && v[s._mstHash]._mstTooltip)
              v[s._mstHash]._mstTooltip.unhover();
          });
        function Z() {
          if (g) return;
          if (x) kb();
        ...
        var kb = (u.show = function() {
          ...
          if (!o._mstTooltip) {
            var lb =
                c.baseURL.substr(0, 8) +
                c.baseURL.substr(8).replace(/\/.*$/, Sb),
              X = e;
            if (jb[c.locale] && fc[jb[c.locale]] && fc[jb[c.locale]] == C)
              X = D;
          ...
          o._mstTooltip.cb.appendChild(
            o.createTextNode(L.innerText || L.textContent)
          );
          ...
          if (
            Microsoft.TranslatorOverride &&
            Microsoft.TranslatorOverride.showTooltip
          )
            try {
          ...
          var g,
            fb =
              h.getStyleValue(s, cb) == C ||
              h.getStyleValue(s, "text-align") == ab;
          if (fb) g = h.absXPos(s) + s.offsetWidth - o._mstTooltip.offsetWidth;
          else g = h.absXPos(s);
          if (g + o._mstTooltip.offsetWidth > h.absXPos(t) + t.offsetWidth)
            g = h.absXPos(t) + t.offsetWidth - o._mstTooltip.offsetWidth;
          if (g < h.absXPos(t) && h.absXPos(t) + m < kb) g = h.absXPos(t);
          if (h.getStyleValue(s, cb) != C) {
            if (g + o._mstTooltip.offsetWidth > O + T - 8)
              g = O + T - 8 - o._mstTooltip.offsetWidth;
            if (g < T + 8) g = T + 8;
          }
          o._mstTooltip.style.left = g + n;
          o._mstTooltip.style.top =
            Math.max(h.absYPos(s) - (o._mstTooltip.offsetHeight + 8), 8) + n;
        });
        function Y() {
          if (g) return;
          if (!x) R();
        ...
        var R = (u.hide = function() {
          ...
          lb = (u.tap = function(a) {
            if (window.WidgetLastHoveredItem != j)
              window.WidgetLastHoveredItem._mstTooltip.unhover(
                window.WidgetLastHoveredItem
              );
            N = D;
            if (o._mstTooltip)
              setTimeout(function() {
    ...
    qc = new function(K) {
      ...
      window._mstCmCb = function() {
        ...
        if (pb) pb.onclick = mb;
        if (h.isInternetExplorer() && h.isQuirksMode(document))
          h.fixIEQuirks(g);
        fb.onclick = function() {
          sb(-3);
          return d;
      ...
      var Yb = (z.showTooltip = function(a, b, c) {
        ...
        Lb = (z.showTranslations = function() {
          ...
          mb();
          rb.style.display = i;
          c.serviceClient.GetTranslations(
            c.appId,
            wb._mstNormalize(),
            Hb,
            Bb,
            24,
            c.category ? { Category: c.category } : tb,
            Nb,
            Qb,
            7e3
          );
      ...
      function Nb(b) {
        ...
        var v =
            kb >= 5 &&
            kb >= Math.abs(b.Translations[0].Rating) &&
            (!xb || xb == Bb.toLowerCase()),
        ...
        if (
          ...
          (document._mstTooltip.style.display == i || g.style.display == i)
        )
          vb();
        return k.slice(0);
      }
        ...
        Eb = (z.showDashboard = function() {
          ...
          setTimeout(function() {
            ...
            if (!h.isInternetExplorer())
              a.style.left = (b.offsetWidth - a.offsetWidth).toString() + bb;
      ...
      function qb(a, f, g) {
        ...
        if (e >= lb) b.pop();
        c.serviceClient.GetTranslationsArray(
          c.appId,
          b,
          f,
          g,
          ...
          function(d) {
            for (var c = 0; c < d.length; ++c)
              if (d[c].Translations.length > 1)
                if (d[c].Translations[0].Rating > 5)
                  a.transItems[s + c].tgt.style.backgroundColor = "#E6E6E6";
                else if (d[c].Translations[1].Count < 0)
                  a.transItems[s + c].tgt.style.backgroundColor = "#E5917F";
        ...
        if (!a) {
          ...
          if (b) a = b[1];
            ...
            document.cookie =
              ...
              ((location.host.indexOf("bing") > e &&
                location.pathname.indexOf("/translator")) > e
                ? location.pathname
                : v);
          }
        }
        ...
        if (I)
          T = function() {
            ...
            if (h.isInternetExplorer() && h.isQuirksMode(document))
              d = "&inrt=1";
            ac = Rb(
              "/ajax/v3/community.aspx?fmt=js&loc=" + Ab + d + r + ob(),
              c.rootURL
            );
          };
        if (c.tokRef) {
          ...
          setInterval(function() {
            if (_eTokenScript)
              _eTokenScript.parentNode.removeChild(_eTokenScript);
            _eTokenScript = Rb(
              "/ajax/v3/community.aspx?reftok=1&" + ob(),
              c.rootURL
            );
          }, c.tokRef * 1e3);
        }
  ...
  (function(h) {
    ...
    function Ub(p, h, b) {
      ...
      for (var i = 0; i < n.length; i++) {
        var o = n[i];
        if (o.getAttribute("type").toLowerCase() == ab)
          o.setAttribute("onclick", xb);
      }
    ...
    function Qb() {
      ...
      if (location.search.length == 0)
        Util.GetElement(c).setAttribute(t, b + Mb + i);
      else if (location.search.indexOf("__mstto") != e) {
        if (b.match(/__mstto=(.+)([&]+)/i))
          Util.GetElement(c).setAttribute(
            t,
            b.replace(/__mstto=(.+)([&&]+)/i, eb + i + r)
          );
        else if (b.match(/__mstto=(.+)/i))
          Util.GetElement(c).setAttribute(
            t,
            b.replace(/__mstto=(.+)/i, eb + i)
          );
...
function CUtil() {
  ...
  a.SetCookie = function(c, b, d, a) {
    if (window.mscc === undefined || window.mscc.hasConsent()) {
      ...
      document.cookie =
        ...
        "=" +
        b +
        (d ? "; expires=Sun, 01-Jan-2040 01:01:01 GMT" : "") +
        "; path=" +
        a;
    }
  };
  ...
  a.AbsXPos = function(a) {
    return (
      a.offsetLeft + (a.offsetParent != b ? this.AbsXPos(a.offsetParent) : 0)
    );
  };
  a.AbsYPos = function(a) {
    return (
      a.offsetTop + (a.offsetParent != b ? this.AbsYPos(a.offsetParent) : 0)
    );
  };
  ...
  a.GetStyleValue = function(e, c) {
    var a = document.getElementById(e) || document.body,
      d;
    if (a.currentStyle)
      d = a.currentStyle[c] || a.currentStyle.getAttribute(c.replace("-"));
    else if (window.getComputedStyle)
      d = document.defaultView.getComputedStyle(a, b).getPropertyValue(c);
    return d;
  };
  ...
  a.getLanguageDirStyle = function(b) {
    ...
    if (Microsoft.Translator.languageDirs[b] == "rtl")
      a = { direction: "rtl", textAlign: "right" };
  ...
  a.GetDocumentUrl = function(d) {
    ...
    else if (d.location.search.indexOf(b) > 0)
      a = decodeURIComponent(
        d.location.search.substring(d.location.search.indexOf(b) + 2)
      );
    while (
      a &&
      a.toLowerCase().indexOf(e) >= 0 &&
      a.toLowerCase().indexOf(b) >= 0
    )
      a = decodeURIComponent(a.substring(a.toLowerCase().indexOf(b) + 2));
    if (a.length > 0) {
  ...
  a.Log = function(b, a) {
    if (window.mscc === undefined || window.mscc.hasConsent())
      Microsoft.Translator.LoadScript(
        "/sync.ashx?svc=" + b + "&" + a.join("&")
      );
  };
  ...
  a.IsDeviceIOS = function() {
    return (
      /IPAD|IPHONE|IPOD/.test(navigator.userAgent.toUpperCase()) &&
      !window.MSStream
    );
  };
...
MtPopUpList.prototype = {
  ...
  getNextSibling: function(g, f) {
    var e = this.getActiveLink(),
      c = e.parentNode;
    while (c.tagName.toLowerCase() != "tr" && c.parentNode != null)
      c = c.parentNode;
  ...
  doKeyPress: function(a) {
    this.execute = function(b) {
      if (!b) b = window.event;
      a.keysBuffer += String.fromCharCode(
      ...
      if (!j) {
        ...
        setTimeout(function() {
          ...
          for (var b = 0; b < c.length; b++) {
            ...
            if (
              f.toLowerCase().indexOf(a.keysBuffer) == 0 &&
              f != (a.getActiveLink().outerText || a.getActiveLink().text)
            ) {
              d = c[b];
              break;
            }
